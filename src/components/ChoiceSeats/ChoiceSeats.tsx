                                ...
                                <>
                                    <div className='row m-0 p-0'>
                                        ...
                                        <div className="col-lg-9 col-12">
                                            <div className="aboutCoachInfo-container d-flex justify-content-between px-3 pt-4 flex-column flex-lg-row align-items-start">
