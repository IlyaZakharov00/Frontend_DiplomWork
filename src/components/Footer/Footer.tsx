...
export const Footer = () => {
  ...
  return (
    <footer className='footer-container bg-black' id='contacts-section'>
      <div className="row d-flex flex-lg-row flex-column justify-content-evenly m-auto w-75 pt-4">
        <div className="col-xl-4 col-lg-5 p-0 pt-3 ps-xl-3 d-flex flex-column align-items-xl-baseline  align-items-lg-center ">
          <h2 className='contactUs_title'>Свяжитесь с нами</h2>
          <ul className='contacts_container p-0 pt-2 mt-3'>
            <li className="contact_item">
              <a href="tel:88005553535" className='text-decoration-none'>
            ...
            <li className="contact_item">
              <a href="mailto:ilya22425@gmail.com" className='text-decoration-none'>
                ...
                <span className='contact_link'>inbox@mail.com</span>
              </a>
            </li>
            <li className="contact_item">
              <a href="skype:tu.train.tickets" className='text-decoration-none'>
            ...
            <li className="contact_item">
              <a href="https://www.google.com/maps?ll=55.752787,37.623562" target="_blank" className='text-decoration-none'>
                ...
                <span className='contact_link contact_link_local'>
                  г. Москва<br></br>
        ...
        <div className="col-xl-6 col-lg-5 p-0 pt-4 ps-xl-5 d-flex flex-column align-items-lg-center align-items-xl-baseline">
          ...
          <form action="submit" className='form_submit d-lg-flex align-items-center flex-wrap w-100 gx-30' id='form_subscribe' onSubmit={subsribeNews}>
            <input type="email" placeholder='email' name='email' className='input_email flex-grow-1' autoComplete='true' required />
          ...
          <div className='links_container d-flex flex-column align-items-lg-center align-items-xl-baseline'>
            ...
            <ul className='links_list d-flex flex-wrap p-0 flex-md-row gap-5 text-sm-center flex-column align-items-center w-100 justify-content-lg-evenly justify-content-xl-between'>
