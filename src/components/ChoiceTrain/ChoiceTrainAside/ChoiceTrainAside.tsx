...
import icon_first_class from '../../../static-files/icons/aside/first_class.svg'
            ...
            <div className="aboutTrain">
                ...
                <ul className='aboutTrain_functionsList aboutTrainSection pt-5 px-4'>
                    <li className='function_item'>
                        <svg className='icon_Func' width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns={icon_second_class}>
                        ...
                        <label className='switch'>
                            <input type="checkbox" className='checkbox' onChange={onChangeHdnler} id='have_second_class' data-option='class' checked={state.class.have_second_class ? state.class.have_second_class : false} />
                            <span className='slider'></span>
                        </label>
                    </li>
                    <li className='function_item'>
                        <svg className='icon_Func' width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns={icon_third_class}>
                        ...
                        <label className='switch'>
                            <input type="checkbox" className='checkbox' onChange={onChangeHdnler} id='have_third_class' data-option='class' checked={state.class.have_third_class ? state.class.have_third_class : false} />
                            <span className='slider'></span>
                        </label>
                    </li>
                    <li className='function_item'>
                        <svg className='icon_Func' width="14" height="23" viewBox="0 0 14 23" fill="none" xmlns={icon_fourth_class}>
                        ...
                        <label className='switch'>
                            <input type="checkbox" className='checkbox' onChange={onChangeHdnler} id='have_fourth_class' data-option='class' checked={state.class.have_fourth_class ? state.class.have_fourth_class : false} />
                            <span className='slider'></span>
                        </label>
                    </li>
                    <li className='function_item'>
                        <svg className='icon_Func' width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns={icon_first_class}>
                        ...
                        <label className='switch'>
                            <input type="checkbox" className='checkbox' onChange={onChangeHdnler} id='have_first_class' data-option='class' checked={state.class.have_first_class ? state.class.have_first_class : false} />
                            <span className='slider'></span>
                        </label>
                    </li>
                    <li className='function_item'>
                        ...
                        <label className='switch'>
                            <input type="checkbox" className='checkbox' onChange={onChangeHdnler} id='have_wifi' data-option='comfortOptions' checked={state.comfortOptions.have_wifi ? state.comfortOptions.have_wifi : false} />
                            <span className='slider'></span>
                        </label>
                    </li>
                    <li className='function_item'>
                        <svg className='icon_Func' width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns={icon_express}>
                        ...
                        <label className='switch'>
                            <input type="checkbox" className='checkbox' onChange={onChangeHdnler} id='have_express' data-option='comfortOptions' checked={state.comfortOptions.have_express ? state.comfortOptions.have_express : false} />
                            <span className='slider'></span>
                        </label>
                    </li>
                </ul>
