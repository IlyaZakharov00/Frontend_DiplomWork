        ...
        <div className="choiceTrain_container">
            <aside className="choiceTrain_aside">
                <div className="aboutTrain">
                    <div className='aboutTrain_dates'>
                        <h2 className='aboutTrain_title'>Дата поездки</h2>
                        <input type="date" className='aboutTrain_input' />
                        <h2 className='aboutTrain_title'>Дата возвращения</h2>
                        <input type="date" className='aboutTrain_input' />
                    </div>
                    <ul className='aboutTrain_functionsList'>
                        <li className='function_item'>
                            <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns={icon_coupe}>
                            ...
                            <span className='function_item_title'>Купе</span>
                            <input type="checkbox" />
                        </li>
                        <li className='function_item'>
                            <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns={icon_plac}>
                        ...
                        <li className='function_item'>
                            <svg width="14" height="23" viewBox="0 0 14 23" fill="none" xmlns={icon_sit}>
                        ...
                        <li className='function_item'>
                            <svg width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns={icon_lux}>
                        ...
                        <li className='function_item'>
                            <svg width="24" height="19" viewBox="0 0 24 19" fill="none" xmlns={icon_wifi}>
                        ...
                        <li className='function_item'>
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns={icon_boost}>
                    ...
                    <div className='aboutTrain_price'>
                        <h2 className='price_title'>Стоимость</h2>
                    </div>
                    <div className='aboutTrain_cityFirst'>
                        <h2 className='cityFirst_title'>Туда</h2>
                    </div>
                    <div className='aboutTrain_citySecond'>
