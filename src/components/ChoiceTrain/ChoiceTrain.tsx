                            ...
                            <aside className="choiceTrain_aside">
                                <div className="aboutTrain">
                                    <div className='aboutTrain_dates aboutTrainSection pt-5 px-4'>
                                        ...
                                        <input type="date" className='aboutTrain_input date_travel w-100' value={state.dates.date_start} readOnly />
                                        <h2 className='aboutTrain_title'>Дата возвращения</h2>
                                        <input type="date" className='aboutTrain_input date_back w-100' value={state.dates.date_end} readOnly />
                                    </div>
                                    <ul className='aboutTrain_functionsList aboutTrainSection pt-5 px-4'>
                                        <li className='function_item'>
                                            ...
                                            <label className='switch'>
                                                <input type="checkbox" className='checkbox' onChange={onChangeHdnler} id='have_first_class' data-option='class' />
                                        ...
                                        <li className='function_item'>
                                            ...
                                            <label className='switch'>
                                                <input type="checkbox" className='checkbox' onChange={onChangeHdnler} id='have_second_class' data-option='class' />
                                                <span className='slider'></span>
                                            </label>
                                        </li>
                                        <li className='function_item'>
                                            ...
                                            <label className='switch'>
                                                <input type="checkbox" className='checkbox' onChange={onChangeHdnler} id='have_third_class' data-option='class' />
                                                <span className='slider'></span>
                                            </label>
                                        </li>
                                        <li className='function_item'>
                                            ...
                                            <label className='switch'>
                                                <input type="checkbox" className='checkbox' onChange={onChangeHdnler} id='have_fourth_class' data-option='class' />
                                                <span className='slider'></span>
                                            </label>
                                        </li>
                                        <li className='function_item'>
                                            ...
                                            <label className='switch'>
                                                <input type="checkbox" className='checkbox' onChange={onChangeHdnler} id='have_wifi' data-option='comfortOptions' />
                                                <span className='slider'></span>
                                            </label>
                                        </li>
                                        <li className='function_item'>
                                            ...
                                            <label className='switch'>
                                                <input type="checkbox" className='checkbox' onChange={onChangeHdnler} id='have_express' data-option='comfortOptions' />
                                                <span className='slider'></span>
                                            </label>
                                        </li>
                                    </ul>
                                    <div className='aboutTrain_price aboutTrainSection'>
                                    ...
                                    <div className='aboutTrain_cityFirst aboutTrainSection'>
                                        <h2 className='cityFirst_title'>Туда</h2>
                                    </div>
                                    <div className='aboutTrain_citySecond aboutTrainSection'>
                                        <h2 className='cityFirst_title'>Обратно</h2>
                                    </div>
                                </div>
                                <div className="lastTickets">
                                    <h2 className='lastTickets_title'>Последние билеты</h2>
                                    <div className='lastTickets_container'></div>
                                </div>
                            </aside>
                        </div>
