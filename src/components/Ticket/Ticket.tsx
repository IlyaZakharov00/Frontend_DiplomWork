                ...
                <div className="ticket_container d-flex flex-xl-row flex-lg-row flex-column" id={item.departure._id}>
                    ...
                    <div className="infoPrice flex-grow-1">
                        ...
                        <div className='footer_ticket_price'>
                            ...
                            {menuState.check ? <button className='changeTrainBtn' onClick={changeTrain}>Изменить</button> : <button className='choiceSeatsBtn' onClick={choiceSeatsHendler}>Выбрать места</button>}
                        </div>
                    </div>
                </div>}
        </>
